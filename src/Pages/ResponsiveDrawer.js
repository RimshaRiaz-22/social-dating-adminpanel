...
function ResponsiveDrawer(props) {
  ...
  const [dobUser, setdobUser] = useState('22-08-2000');
    ...
    <div style={{ overflow: 'hidden' }}>
      ...
      <List className={classes.listStyle}>
        ...
        <ListItem disablePadding selected={selectedIndex === 3} onClick={(event) => {
          ...
          <ListItemIcon>
            {/* className={classes.iconColor} */}
            <ReceiptOutlinedIcon className={classes.iconColor} />
          </ListItemIcon>
        ...
        <ListItem disablePadding selected={selectedIndex === 4} onClick={(event) => {
          ...
          <ListItemIcon>
            {/* className={classes.iconColor} */}
            <LockOutlinedIcon className={classes.iconColor} />
          </ListItemIcon>
              ...
              >
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={12} align="center" >
                    ...
                    <Button type="primary" className='btnBg' htmlType="submit" onClick={handleOk} >
                                                Submit
                                            </Button>
                    </div>
                  </Grid>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={12} align="center" >
                    <div className="d-grid gap-2 col-12 mx-auto">
                      ...
                      <Button type="primary" className='btnBg' htmlType="submit" onClick={() => {
          ...
          >
            ...
            >
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12} align="center" >
                  <div className="d-grid gap-2 col-12 mx-auto">
                    <Button type="primary" className='btnBg' htmlType="submit" onClick={handleOkAccount}>
                                                Submit
                                            </Button>
                  </div>
                </Grid>
        ...
        <Main open={open} style={MarginTop} className={classes.BackGround}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={12} style={paddingGrid}>
              ...
              {show ? <Dashboard /> : null}
              {show1 ? <Users /> : null}
              {show2 ? <SubscriptionData /> : null}
              {show3 ? <TermsAndConditions /> : null}
              {show4 ? <PrivacyPolicy /> : null}
              {/* {show5 ? <SalesOrder /> : null} */}
