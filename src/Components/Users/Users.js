...
import {CRow,CCol ,CDropdown ,CDropdownItem,CDropdownMenu,CWidgetStatsB,CDropdownToggle} from '@coreui/react'
...
function Users() {
            ...
            <div style={marginTop}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={12}>
                        ...
                        >
                            <Item sx={{ flexGrow: 2 }}>
                                <Typography variant='h6' style={{ fontWeight: 700 }} >Users</Typography>
                            </Item>
                            <Item>
  ...
  <CCol xs={4}>
    ...
    <Tabs.TabPane tab="Monthly Subscribed Users" key="2">
    <Grid item xs={12} md={12}>
                        <div className='tableResponsive'>
                            <Table columns={columns} dataSource={data} />
                        </div>
    ...
    <Tabs.TabPane tab="Yearly Subscribed Users" key="3">
    <Grid item xs={12} md={12}>
                        <div className='tableResponsive'>
                            <Table columns={columns} dataSource={data} />
                        </div>
